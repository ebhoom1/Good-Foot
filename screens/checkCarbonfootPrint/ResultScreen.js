...
const ResultScreen = ({ navigation }) => {
  const confirmed = () => {
    navigation.navigate('MainTabs'); // Navigate to the main tabs or home screen
  };
      ...
      <View style={styles.overlay}>
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.resultBox}>
            ...
            <Text style={styles.resultValue}>2.33</Text>
            <Text style={styles.resultUnit}>Tons CO₂e</Text>
          </View>
